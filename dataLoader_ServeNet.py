...
def load_data(data_config, data_path=None, data_type='allData', use_previousData=False):
    ...
    if use_previousData:
        ...
        if data_type == 'All':
            ...
            # dataset.test_data = dataset.load_TrainTestData(file, 53, 59)
...
class dataEngine(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        return (ids, token_type_ids, attention_mask, dscp_tokens, title_ids, title_token_type_ids, title_attention_mask), tags, dscp
